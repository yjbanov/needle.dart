...
class Batch {
  List<int> mSamType;
  List<String> mSamName;
  List<double> mSamTime;
}
...
class Needle {
  ...
  addBatch() {
    var btc = new Batch()
      ..mSamType = new List<int>(this.mArraySize)
      ..mSamName = new List<String>(this.mArraySize)
      ..mSamTime = new List<double>(this.mArraySize);
    this.mCurrBatch = btc;
